   	             	...
   	             	<form id="profileForm" method="post">
   	                	...
   	                	<div id="user_id-box"> 
   	                		...
   	                		<c:if test="${user_code==userInfo.user_code}">
   	                			<input type="button" value="프로필 편집" id="profile-btn"/>     
   	                			<input type="button" value="메세지보내기" id="message-btn" />  
   	                		</c:if>
   	                		</p>
   	                	</div>
   	                	<div id="button-box">
