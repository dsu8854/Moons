...
<form name="frm" id="frm" method="post">
		<div class="service_header" id="service_header" >	
				...
				<div class="wrap_inner">
					<div class="f">
						<div class="f_l">
							<span class="glyphicon glyphicon-align-justify" id="menu_btn" style="cursor:pointer">
							</span>
						</div>
					...
					<div class="title">
						<div class="background_img" id="background_img" >
							...
							<br/>
							<span class="glyphicon glyphicon-text-background" id="btn_colorChange" style="cursor:pointer"></span>
							<br/>
							<br/>
					...
					<div class="board_subject_wrapper" >
						<div class="cover_item">
							<div class="cover_cell">
								<h1 class="cover_title" id="board_subject_cover" contenteditable="true">제목을 입력하세요.</h1>
